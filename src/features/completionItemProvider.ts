...
const declarations = `memory|import|export|func|param|local|module|result|type|anyfunc|table|elem|data`;
const controls = `unreachable|nop|block|loop|if|else|br|br_if|br_table|return`;
